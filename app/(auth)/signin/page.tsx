            ...
            <div className="w-full overflow-hidden  bg-blue-400 flex items-center justify-center min-h-screen relative z-10">
                ...
                <div className="w-full max-w-[1190px] px-6 sm:px-8 md:px-16 py-10 md:py-20 rounded-xl  min-h-[300px] m-2">
                    ...
                    <div className="w-full max-w-md mx-auto p-6">
                        <div className="mt-7 border border-blue-200 rounded-xl shadow-lg bg-blue-500">
                            <div className="p-4 sm:p-7">
                                ...
                                <div className="mt-5">
                                    <button type="button" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-blue-200 bg-[#333] text-white shadow-sm hover:bg-blue-50 disabled:opacity-50 disabled:pointer-events-none">
                                    ...
                                    <form action={handleSubmit} >
                                        <div className="grid gap-y-4">
                                            ...
                                            <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-700 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">Sign In</button>
                                        </div>
                                    </form>
                                    {/* End Form */}
                                </div>
